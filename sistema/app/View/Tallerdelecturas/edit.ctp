...
<?php echo $this->Form->create('Tallerdelectura'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tallerdelectura'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Tallerdelectura.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Tallerdelectura.id'))); ?></li>
